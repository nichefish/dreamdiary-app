...
Example (stance): `나는 원빈님을 어떻게 생각하고 있니?`

**Not stance** — use person-meaning / appearance prompt instead: `내 대화에서 가영님은 어떤 느낌으로 등장하고 있니?`
