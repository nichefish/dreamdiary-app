...
| 내 설정 | `/my/profile`, `/my/security`, `/my/prefixes` | `UserMyPage.vue` + `UserMy*Tab.vue` | — | DefaultLayout | ✓ | ❌ |
...
- **Vue SPA**: `/my/profile`, `/my/security`, `/my/prefixes` (`/my`는 `/my/profile`로 redirect)
