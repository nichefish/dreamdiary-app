package io.nicheblog.dreamdiary.feature.attachable.comment.repository.jpa;

import io.nicheblog.dreamdiary.auth.security.config.TestAuditConfig;
import io.nicheblog.dreamdiary.feature.attachable.comment.entity.CommentEntity;
import io.nicheblog.dreamdiary.feature.attachable.comment.entity.CommentEntityTestFactory;
...
class CommentRepositoryTest {
    ...
    void setUp() throws Exception {
        // 공통적으로 사용할 commentEntity 초기화
        commentEntity = CommentEntityTestFactory.create();
    }
