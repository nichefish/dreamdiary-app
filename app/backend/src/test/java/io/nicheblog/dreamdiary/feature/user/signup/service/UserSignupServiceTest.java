...
class UserSignupServiceTest {
    ...
    void testRegist() throws Exception {
        ...
        final UserSignupRequestDto registDto = UserSignupRequestDtoTestFactory.create(profile, emplym);

        // When::
        when(passwordEncoder.encode(anyString())).thenReturn("encoded_password");       // 패스워드 인코딩 Mock
        final ServiceResponse result = userSignupService.regist(registDto);
        final UserSignupRequestDto registered = (UserSignupRequestDto) result.getRsltObj();
