package io.nicheblog.dreamdiary.feature.attachable.history.entity;
...
public class HistoryEntity
     ...
     */
    public HistoryEntity(final BaseAttachableKey refKey) {
     ...
     * @param content 변경내용
     */
    public HistoryEntity(final BaseAttachableKey refKey, final String content) {
        this(refKey);
     ...
     */
    public HistoryEntity(final BaseAttachableKey refKey, final String content, final HistoryType historyType, final Integer fromHistoryId) {
        this(refKey, content);
