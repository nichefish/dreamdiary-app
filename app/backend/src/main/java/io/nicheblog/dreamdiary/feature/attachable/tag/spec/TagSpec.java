package io.nicheblog.dreamdiary.feature.attachable.tag.spec;
...
public class TagSpec
    ...
    public List<Predicate> getPredicateWithParams(
        ...
        predicate.add(builder.equal(tagContentJoin.get("createdBy"), AuthUtils.getLoginUsernameOrDefault()));     // 등록자 ID 기준으로 조회
