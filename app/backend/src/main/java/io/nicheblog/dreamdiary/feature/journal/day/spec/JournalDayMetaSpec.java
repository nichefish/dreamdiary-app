...
import io.nicheblog.dreamdiary.feature.journal.day.entity.JournalDayMetaContentEntity;
...
@Component
@Log4j2
public class JournalDayMetaSpec
        implements BaseSpec<JournalDayMetaEntity> {
    ...
    public void postQuery(
            final Root<JournalDayMetaEntity> root,
        ...
        for (final String key : searchParamMap.keySet()) {
            ...
            switch (key) {
                ...
                case "mnth":
                    ...
                    continue;
                case "createdBy":
                    predicate.add(builder.equal(journalDayMetaJoin.get("createdBy"), value));     // 등록자 ID 기준으로 조회
            }
        }
