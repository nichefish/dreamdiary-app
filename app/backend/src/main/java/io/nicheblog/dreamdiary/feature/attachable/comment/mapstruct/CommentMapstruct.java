package io.nicheblog.dreamdiary.feature.attachable.comment.mapstruct;
...
public interface CommentMapstruct
        extends BaseWriteMapstruct<CommentDto, CommentEntity>, BaseAttachableMapstruct<CommentDto, CommentEntity> {
