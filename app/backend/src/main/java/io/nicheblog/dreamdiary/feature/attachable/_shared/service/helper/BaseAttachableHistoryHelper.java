...
import io.nicheblog.dreamdiary.feature.attachable.history.service.HistoryChangeUtils;
import io.nicheblog.dreamdiary.global.handler.ApplicationEventPublisherWrapper;
import io.nicheblog.dreamdiary.global.handler.SpringBeanProvider;
import lombok.experimental.UtilityClass;

@UtilityClass
public final class BaseAttachableHistoryHelper {

    public static boolean isHistoryModule(final Object entity) {
        return entity instanceof HistoryEmbedModule;
    }

    public static void applyModifyHistory(final BaseAttachableEntity beforeEntity, final BaseAttachableEntity afterEntity) throws Exception {
    ...
    public static <Entity extends BaseAttachableEntity> void publishHistoryEventIfSupported(
            final Object source,
