...
-- 최상위 메뉴
INSERT INTO menu ( upper_menu_id, menu_ty_cd, menu_nm, sort_order, menu_sub_extend_ty_cd, menu_label, mngr_yn, protected_yn, required_yn, use_yn, created_by )
VALUES
(NULL, 'MAIN', '사용자', 0, 'LIST', 'MAIN', 'N','Y','Y','Y','SYSTEM'),
(NULL, 'MAIN', '관리자', 0, 'LIST', 'ADMIN_MAIN', 'Y','Y','Y','Y','SYSTEM');

-- 공지사항
INSERT INTO menu ( upper_menu_id, menu_ty_cd, menu_label, menu_nm, url, sort_order, menu_sub_extend_ty_cd, mngr_yn, protected_yn, required_yn, use_yn, created_by )
