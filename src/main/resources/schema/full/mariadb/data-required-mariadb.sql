...
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('CL_CTGR_CD', 'SYS', '시스템', '시스템에서 필수적으로 사용되는 코드입니다.', '1');
...
-- 필수 :: 잔디 토픽 상세 코드 추가
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('JANDI_TOPIC_CD', 'NOTICE', '공지사항', '공지사항', '1');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('JANDI_TOPIC_CD', 'SCHDUL', '일정공유', '일정공유', '2');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('JANDI_TOPIC_CD', 'TEST', '테스트', '테스트', '99');
...
-- 필수 :: 수정권한 상세 코드 추가
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('MDFABLE_CD', 'REGSTR', '등록자', '등록자만 수정 가능', '1');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('MDFABLE_CD', 'MNGR', '관리자', '관리자만 수정 가능', '2');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('MDFABLE_CD', 'USER', '사용자', '사용자만 수정 가능', '3');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('MDFABLE_CD', 'ALL', '전체', '전체 수정 가능', '99');
...
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('JRNL_SUMRY_TY_CD', 'DIARY', '일기', '일기 결산', '1');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('JRNL_SUMRY_TY_CD', 'DREAM', '꿈', '꿈 결산', '2');
...
-- (구) 필수 :: 휴가 상세 코드 추가
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('VCATN_CD', 'ANNUAL', '연차', '연차', '1');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('VCATN_CD', 'AM_HALF', '오전반차', '오전반차', '2');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('VCATN_CD', 'PM_HALF', '오후반차', '오후반차', '3');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('VCATN_CD', 'PBLEN', '공가', '공가', '4');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('VCATN_CD', 'CTSNN', '경조휴가', '경조휴가', '5');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('VCATN_CD', 'MNSTR', '생리휴가', '생리휴가', '6');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('VCATN_CD', 'UNPAID', '무급휴가', '무급휴가', '7');
...
-- 하위메뉴 확장 유형 상세 코드 추가
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('MENU_SUB_EXTEND_TY_CD', 'NO_SUB', '하위메뉴 없음', '하위메뉴 없음 (대메뉴가 링크로 기능함)', '0');
INSERT IGNORE INTO cmm_dtl_cd (cl_cd, dtl_cd, dtl_cd_nm, dc, idx) VALUES ('MENU_SUB_EXTEND_TY_CD', 'LIST', '아래로 목록 표시', '아래로 목록 표시', '1');
