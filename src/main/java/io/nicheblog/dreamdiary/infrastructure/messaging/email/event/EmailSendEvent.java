package io.nicheblog.dreamdiary.infrastructure.messaging.email.event;

import io.nicheblog.dreamdiary.infrastructure.messaging.email.handler.EmailEventListener;
