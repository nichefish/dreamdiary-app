 ...
 * @author nichefish
 */
public interface BaseSortableService<PostDto extends BaseCrudDto & Identifiable<Key> & Sortable, Key extends Serializable, Entity extends BaseCrudEntity & Sortable>
     ...
     */
    @Transactional
    default ServiceResponse sortIdx(final List<PostDto> idxs) throws Exception {
     ...
     *
     */
    default void postSortIdx(final List<PostDto> idxs) throws Exception {
