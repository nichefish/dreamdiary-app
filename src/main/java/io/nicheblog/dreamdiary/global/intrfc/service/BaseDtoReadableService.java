 ...
 * BaseReadableService
 * <pre>
 *  (공통/상속) 읽기 (dto level) 서비스 인터페이스.
 * </pre>
 *
 * @author nichefish
 */
public interface BaseDtoReadableService<Dto extends BaseCrudDto & Identifiable<Key>, Key extends Serializable, Entity extends BaseCrudEntity>
