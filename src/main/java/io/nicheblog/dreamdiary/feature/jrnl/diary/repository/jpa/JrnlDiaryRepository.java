package io.nicheblog.dreamdiary.feature.jrnl.diary.repository.jpa;
...
public interface JrnlDiaryRepository
    ...
    @Query("SELECT MAX(diary.idx) " +
            ...
            "WHERE diary.jrnlChapter.id = :jrnlChapterId")
    Optional<Integer> findLastIndexByJrnlChapter(final @Param("jrnlChapterId") Integer jrnlChapterId);
}
