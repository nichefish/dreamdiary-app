package io.nicheblog.dreamdiary.feature.jrnl.todo.spec;
 ...
 * JrnlTodoSpec
 * <pre>
 *  저널 할일 목록 검색인자 세팅 Specification.
 * </pre>
 *
 * @author nichefish
 */
@Component
@Log4j2
public class JrnlTodoSpec
        implements BaseClsfSpec<JrnlTodoEntity> {
    ...
    public void postQuery(
            final Root<JrnlTodoEntity> root,
