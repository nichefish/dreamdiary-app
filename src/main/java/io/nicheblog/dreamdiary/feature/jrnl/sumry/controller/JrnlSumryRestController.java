...
import io.nicheblog.dreamdiary.feature.jrnl.sumry.type.JrnlSumryTagType;
...
public class JrnlSumryRestController
    ...
    public ResponseEntity<AjaxResponse> jrnlSumryImprtcDiaryListAjax(
        ...
        return ResponseEntity.ok(AjaxResponse.withAjaxResult(isSuccess, rsltMsg).withList(jrnlDiaryYySumryStatedListByUser));
    }
