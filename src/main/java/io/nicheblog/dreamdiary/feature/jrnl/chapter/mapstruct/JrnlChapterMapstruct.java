package io.nicheblog.dreamdiary.feature.jrnl.chapter.mapstruct;
...
public abstract class JrnlChapterMapstruct
        implements BaseWriteMapstruct<JrnlChapterDto, JrnlChapterEntity>, BaseClsfMapstruct<JrnlChapterDto, JrnlChapterEntity> {
    ...
    @Mapping(target = "ctgrNm", expression = "java(CdUtils.getDtlCdNm(\"JRNL_CHAPTER_CTGR_CD\", entity.getCtgrCd()))")
    public abstract JrnlChapterDto toDto(final JrnlChapterEntity entity) throws Exception;
     ...
     */
    @Named("toSmpDto")
    public abstract JrnlChapterSmpDto toSmpDto(final JrnlChapterEntity entity) throws Exception;
     ...
     */
    @Override
    public abstract JrnlChapterEntity toEntity(final JrnlChapterDto dto) throws Exception;
    ...
    public abstract void updateFromDto(final JrnlChapterDto dto, final @MappingTarget JrnlChapterEntity entity) throws Exception;
     ...
     */
    public List<JrnlChapterSmpDto> toSmpDtoList(final List<JrnlChapterEntity> entityList) {
