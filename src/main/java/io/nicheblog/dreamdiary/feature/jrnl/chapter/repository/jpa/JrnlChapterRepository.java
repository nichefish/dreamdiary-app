package io.nicheblog.dreamdiary.feature.jrnl.chapter.repository.jpa;
 ...
 * @author nichefish
 */
@Repository("jrnlChapterRepository")
public interface JrnlChapterRepository
        extends BaseStreamRepository<JrnlChapterEntity, Integer> {
