...
@SQLDelete(sql = "UPDATE journal_sumry SET deleted_at = NOW() WHERE id = ?")
public class JournalSumryEntity
    ...
    /** 필수: 컨텐츠 타입 */
    @Builder.Default
    @Column(name = "content_type", columnDefinition = "VARCHAR(50) DEFAULT 'JOURNAL_SUMRY'")
     ...
     */
    public JournalSumryEntity(final Integer yy) {
        this.yy = yy;
    }
