...
@Component
@Log4j2
public class JournalDreamTagSpec
        implements BaseSpec<JournalDreamTagEntity> {
    ...
    public void postQuery(
            final Root<JournalDreamTagEntity> root,
        ...
        for (final String key : searchParamMap.keySet()) {
            ...
            switch (key) {
                ...
                case "weekStartDt":
                    ...
                    continue;
                case "createdBy":
                    predicate.add(builder.equal(journalDreamTagJoin.get("createdBy"), value));
                    continue;
                default:
                    continue;
            }
