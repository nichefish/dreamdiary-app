...
public class JournalDiarySpec
    ...
    public void postQuery(
            final Root<JournalDiaryEntity> root,
    ...
    public List<Predicate> getPredicateWithParams(
        ...
        for (final String key : searchParamMap.keySet()) {
            ...
            switch (key) {
                ...
                case "tagId":
                    // 특정 태그된 일기만 검색
                    final Join<JournalDiaryEntity, TagEmbed> tagJoin = root.join("tag", JoinType.INNER);
                ...
                case "tagIds":
                    ...
                    sub.where(
                        builder.and(
                            ...
                            builder.equal(subRoot.get("refContentType"), ContentType.JOURNAL_DIARY.key),
