package io.nicheblog.dreamdiary.feature.journal.interpretation.controller;
...
import io.nicheblog.dreamdiary.feature.journal.interpretation.service.my.MyJournalInterpretationService;
...
/**
 * JournalInterpretationRestController
 * <pre>
...
public class JournalInterpretationRestController
    ...
    private final MyJournalInterpretationService myJournalInterpretationService;
     ...
     */
    @GetMapping(value = {Url.JOURNAL_INTERPRETATIONS})
    @Secured({Constant.ROLE_USER, Constant.ROLE_MNGR})
    @ResponseBody
    public ResponseEntity<AjaxResponse> journalInterpretationListAjax(
            JournalInterpretationSearchParam searchParam
    ) throws Exception {
     ...
     * (사용자USER, 관리자MNGR만 접근 가능.)
     *
     * @param journalInterpretation 등록/수정 처리할 객체
