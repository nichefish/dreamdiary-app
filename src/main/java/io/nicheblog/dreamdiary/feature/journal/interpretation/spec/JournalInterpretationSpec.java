...
import io.nicheblog.dreamdiary.feature.journal.interpretation.entity.JournalInterpretationSmpEntity;
...
public class JournalInterpretationSpec
    ...
    public void postQuery(
        ...
        final Join<JournalInterpretationEntity, JournalDreamSmpEntity> journalDreamJoin = root.join("journalDream", JoinType.INNER);
    ...
    public List<Predicate> getPredicateWithParams(
        ...
        // expressions
        final Join<JournalInterpretationSmpEntity, JournalDreamSmpEntity> journalDreamJoin = root.join("journalDream", JoinType.INNER);
        final Join<JournalDreamSmpEntity, JournalDaySmpEntity> journalDayJoin = journalDreamJoin.join("journalDay", JoinType.INNER);
        ...
        for (final String key : searchParamMap.keySet()) {
            ...
            switch (key) {
                ...
                case "journalDreamId":
                    // 꿈 id alias 검색
                    predicate.add(builder.equal(journalDreamJoin.get("id"), value));
                    continue;
                case "diaryKeyword":
                    // 내용 like 검색
