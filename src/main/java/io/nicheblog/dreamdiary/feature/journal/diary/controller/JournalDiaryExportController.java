...
import io.nicheblog.dreamdiary.feature.journal.diary.service.JournalDiaryExportService;
...
public class JournalDiaryExportController
    ...
    private final JournalDiaryExportService journalDiaryExportService;
     ...
     */
    @GetMapping(value = Url.JOURNAL_DIARIES_EXPORT, produces = "text/plain; charset=UTF-8")
    public ResponseEntity<byte[]> journalDiaryExportTxt(
        ...
        final String text = journalDiaryExportService.buildTxt(journalDiaryList, searchParam);
