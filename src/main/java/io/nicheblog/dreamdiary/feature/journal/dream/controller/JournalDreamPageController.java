...
public class JournalDreamPageController
        extends BaseControllerImpl {

    @Getter
    private final String baseUrl = Url.JOURNAL_DREAM_SEARCH;         // 기본 URL
    @Getter
     ...
     */
    @GetMapping(Url.JOURNAL_DREAM_SEARCH)
    @Secured({Constant.ROLE_USER, Constant.ROLE_MNGR})
    public String journalDreamSearch(
        ...
        return "/view/feature/journal/dream/journal_dream_search";
    }
}
