package io.nicheblog.dreamdiary.feature.journal.annual.spec;
...
public class JournalAnnualReviewSpec
        implements BaseClsfSpec<JournalAnnualReviewEntity> {
    ...
    public void postQuery(
            final Root<JournalAnnualReviewEntity> root,
