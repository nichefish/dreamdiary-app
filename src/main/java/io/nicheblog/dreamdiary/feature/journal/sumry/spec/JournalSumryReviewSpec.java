package io.nicheblog.dreamdiary.feature.journal.sumry.spec;
...
/**
 * JournalSumryReviewSpec
 * <pre>
 *  저널 결산 리뷰 목록 검색인자 세팅 Specification.
 * </pre>
 *
 * @author nichefish
 */
@Component
@Log4j2
public class JournalSumryReviewSpec
        implements BaseClsfSpec<JournalSumryReviewEntity> {
    ...
    public void postQuery(
            final Root<JournalSumryReviewEntity> root,
