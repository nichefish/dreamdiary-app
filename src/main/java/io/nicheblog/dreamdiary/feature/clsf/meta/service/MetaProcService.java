...
public class MetaProcService {
    ...
    public void process(
        ...
        if (metaCmpstn == null) {
            delExistingMetaContents(clsfKey);
        } else {
            procMetas(clsfKey, metaCmpstn);
        }
     ...
     */
    @Transactional
    public void delExistingMetaContents(final BaseClsfKey clsfKey) throws Exception {
        if (clsfKey == null) return;
     ...
     */
    @Transactional
    public void procMetas(final BaseClsfKey clsfKey, final MetaCmpstn metaCmpstn) throws Exception {
        if (clsfKey == null || metaCmpstn == null) return;
