package io.nicheblog.dreamdiary.feature.clsf.file.adapter;
...
public final class EmailAttachmentAdapter {
     ...
     */
    public static EmailAttachment toEmailAttachment(final AtchFileDtlDto dto) {
     ...
     */
    public static List<EmailAttachment> toEmailAttachmentList(final List<AtchFileDtlDto> dtoList) {
