package io.nicheblog.dreamdiary.feature.clsf.file.mapstruct;
...
public interface AtchFileMapstruct
        extends BaseWriteMapstruct<AtchFileDto, AtchFileEntity>, BaseReadMapstruct<AtchFileDto, AtchFileEntity> {
