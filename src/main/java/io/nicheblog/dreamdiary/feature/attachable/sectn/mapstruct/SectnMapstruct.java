package io.nicheblog.dreamdiary.feature.attachable.sectn.mapstruct;
 ...
 * @author nichefish
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE, imports = {DateUtils.class, StringUtils.class, MarkdownUtils.class, SectnEmbedMapstruct.class, CodeUtils.class}, builder = @Builder(disableBuilder = true))
public interface SectnMapstruct
        extends BaseWriteMapstruct<SectnDto, SectnEntity>, BaseAttachableMapstruct<SectnDto, SectnEntity> {
