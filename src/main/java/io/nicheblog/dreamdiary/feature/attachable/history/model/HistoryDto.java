package io.nicheblog.dreamdiary.feature.attachable.history.model;
...
public class HistoryDto
     ...
     */
    public HistoryDto(final BaseAttachableKey refKey) {
        this.refId = refKey.getId();
        this.refContentType = refKey.getContentType();
    }

    public HistoryDto(final BaseAttachableKey refKey, final String content) {
        this(refKey);
