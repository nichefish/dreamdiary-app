...
public class JournalTagCacheUpdtWorker {
    ...
    public String getSizedTagMapCacheNmByContentType(final String contentType) {
        if (ContentType.JOURNAL_DAY.key.equals(contentType)) {
            return "journalDayCountMapByUser";
        } else if (ContentType.JOURNAL_DIARY.key.equals(contentType)) {
    ...
    private String getTagListCacheNmByContentType(final String contentType) {
        if (ContentType.JOURNAL_DAY.key.equals(contentType)) {
            return "journalDayYyMnthTagListByUser";
        } else if (ContentType.JOURNAL_DIARY.key.equals(contentType)) {
    ...
    private String getSizedTagListCacheNmByContentType(final String contentType) {
        if (ContentType.JOURNAL_DAY.key.equals(contentType)) {
            return "journalDayYyMnthSizedTagListByUser";
        } else if (ContentType.JOURNAL_DIARY.key.equals(contentType)) {
