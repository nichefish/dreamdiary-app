package io.nicheblog.dreamdiary.feature.attachable._shared.service;
 ...
 * @author nichefish
 */
public interface BaseAttachableService<PostDto extends BaseAttachableDto & Identifiable<Key>, Dto extends BaseAttachableDto & Identifiable<Key>, Key extends Serializable, Entity extends BaseAttachableEntity>
    ...
    default ServiceResponse modify(final PostDto postDto) throws Exception {
        ...
        final Entity historySnapshot = BaseAttachableHistoryHelper.isHistoryModule(modifyEntity)
