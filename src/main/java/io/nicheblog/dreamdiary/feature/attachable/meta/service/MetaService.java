...
import io.nicheblog.dreamdiary.feature.attachable.meta.mapstruct.MetaMapstruct;
...
import io.nicheblog.dreamdiary.feature.attachable.meta.spec.MetaSpec;
...
public class MetaService
    ...
    public Integer calcMaxSize(final List<MetaDto> metaList, final String contentType) {
        ...
        for (final MetaDto meta : metaList) {
            // 캐싱 처리 위해 셀프 프록시
            final Integer metaSize = this.countMetaSize(meta.getId(), contentType, AuthUtils.getLoginUsername());
