package io.nicheblog.dreamdiary.extension.clsf.meta.spec;
...
public class MetaSpec
    ...
    public List<Predicate> getPredicateWithParams(
        ...
        predicate.add(builder.equal(metaContentJoin.get("regstrId"), AuthUtils.getLgnUserIdOrDefault()));     // 등록자 ID 기준으로 조회
