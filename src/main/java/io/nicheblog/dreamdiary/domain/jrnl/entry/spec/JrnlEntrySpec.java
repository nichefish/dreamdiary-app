package io.nicheblog.dreamdiary.domain.jrnl.entry.spec;
 ...
 * JrnlEntrySpec
 * <pre>
 *  저널 항목 목록 검색인자 세팅 Specification.
 * </pre>
 *
 * @author nichefish
 */
@Component
@Log4j2
public class JrnlEntrySpec
        implements BaseClsfSpec<JrnlEntryEntity> {
    ...
    public void postQuery(
            final Root<JrnlEntryEntity> root,
