...
public class JrnlDiaryService
        implements BaseClsfService<JrnlDiaryPostDto, JrnlDiaryDto, Integer, JrnlDiaryEntity>, BaseMultiCrudService<JrnlDiaryPostDto, JrnlDiaryDto, Integer, JrnlDiaryEntity> {
