package io.nicheblog.dreamdiary.domain.clsf.viewer.mapstruct;

import io.nicheblog.dreamdiary.domain.clsf.viewer.entity.ViewerEntity;
import io.nicheblog.dreamdiary.domain.clsf.viewer.model.ViewerDto;
...
public interface ViewerMapstruct
        extends BaseWriteMapstruct<ViewerDto, ViewerEntity>, BaseReadMapstruct<ViewerDto, ViewerEntity> {
