package io.nicheblog.dreamdiary.domain.clsf.managt.repository.jpa;

import io.nicheblog.dreamdiary.global.TestConstant;
import io.nicheblog.dreamdiary.domain.clsf.managt.entity.ManagtrEntity;
import io.nicheblog.dreamdiary.domain.clsf.managt.entity.ManagtrEntityTestFactory;
...
/**
 * ManagtrRepositoryTest
 * <pre>
 *  조치자 (JPA) Repository 테스트 모듈.
...
class ManagtrRepositoryTest {
    ...
    private ManagtrEntity managtrEntity;
    ...
    void setUp() throws Exception {
        // 공통적으로 사용할 managtrEntity 초기화
        managtrEntity = ManagtrEntityTestFactory.create();
    }
