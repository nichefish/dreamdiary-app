...
import io.nicheblog.dreamdiary.auth.security.entity.RoleEntityTestFactory;
...
class RoleRepositoryTest {
    ...
    void setUp() throws Exception {
        // 공통적으로 사용할 roleEntity 초기화
        roleEntity = RoleEntityTestFactory.create();
    }
    ...
    public void testRegist() throws Exception {
        ...
        // When::
        final RoleEntity registered = roleRepository.save(roleEntity);
        final Integer id = registered.getId();
        final RoleEntity retrieved = roleRepository.findById(id).orElseThrow(() -> new EntityNotFoundException(MessageUtils.getMessage("exception.EntityNotFoundException.registered")));

        // Then::
        assertNotNull(retrieved, "저장한 데이터를 조회할 수 없습니다.");
        assertNotNull(retrieved.getRoleKey(), "저장된 엔티티의 key 값이 없습니다.");
    }
}
