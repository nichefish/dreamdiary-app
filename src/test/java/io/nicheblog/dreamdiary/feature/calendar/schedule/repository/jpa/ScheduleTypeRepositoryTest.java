...
import io.nicheblog.dreamdiary.feature.calendar.schedule.entity.ScheduleEntityTestFactory;
...
@Log4j2
class ScheduleTypeRepositoryTest {
    ...
    void setUp() throws Exception {
        // 공통적으로 사용할 scheduleEntity 초기화
        scheduleEntity = ScheduleEntityTestFactory.create();
    }
    ...
    public void testRegist() throws Exception {
        ...
        // When::
        final ScheduleEntity registered = scheduleRepository.save(scheduleEntity);
        final Integer key = registered.getId();
        final ScheduleEntity retrieved = scheduleRepository.findById(key).orElseThrow(() -> new EntityNotFoundException(MessageUtils.getMessage("exception.EntityNotFoundException.registered")));
    ...
    public void testModify() throws Exception {
        // Given::
        ScheduleEntity registered = scheduleRepository.save(scheduleEntity);
    ...
    public void testDelete() throws Exception {
        ...
        // When::
        final ScheduleEntity toDelete = scheduleRepository.findById(key).orElseThrow(() -> new EntityNotFoundException(MessageUtils.getMessage("exception.EntityNotFoundException.to-delete")));
        scheduleRepository.delete(toDelete);

        final ScheduleEntity retrieved = scheduleRepository.findById(key).orElse(null);
