...
import io.nicheblog.dreamdiary.feature.jrnl.sbjct.model.JrnlSbjctDtoTestFactory;
...
class JrnlSbjctServiceTest {
    ...
    void regist() throws Exception {
        ...
        // When::
        final ServiceResponse registResult = jrnlSbjctService.regist(jrnlSbjct);
    ...
    void delete() throws Exception {
        ...
        // When::
        final ServiceResponse deleteResult = jrnlSbjctService.delete(key);
