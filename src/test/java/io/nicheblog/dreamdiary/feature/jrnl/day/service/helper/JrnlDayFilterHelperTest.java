...
class JrnlDayFilterHelperTest {
    ...
    void filterInMemory_doesNotReduceMonthListToAnchorDayWhenChapterCategoryFilterIsUsed() {
        final JrnlDayDto firstDay = JrnlDayDto.builder()
                .jrnlDt("2026-04-01")
                .jrnlChapterList(List.of(createChapter("SUMMARY", "first summary")))
                .build();
        final JrnlDayDto secondDay = JrnlDayDto.builder()
                .jrnlDt("2026-04-02")
                .jrnlChapterList(List.of(createChapter("SUMMARY", "second summary")))
                .build();
    ...
    private JrnlChapterDto createChapter(final String ctgrCd, final String diaryContent) {
        return JrnlChapterDto.builder()
                .ctgrCd(ctgrCd)
