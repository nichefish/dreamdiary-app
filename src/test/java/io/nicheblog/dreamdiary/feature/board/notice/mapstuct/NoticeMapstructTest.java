package io.nicheblog.dreamdiary.feature.board.notice.mapstuct;

import io.nicheblog.dreamdiary.feature.board.notice.entity.NoticeEntity;
import io.nicheblog.dreamdiary.feature.board.notice.entity.NoticeEntityTestFactory;
...
import io.nicheblog.dreamdiary.feature.board.notice.model.NoticeDtoTestFactory;
...
class NoticeMapstructTest {
    ...
    void testToDto_checkAuditor() throws Exception {
        ...
        // 등록자 / 수정자
        BaseEntityTestFactoryHelper.setCreatedByInfo(noticeEntity);
        BaseEntityTestFactoryHelper.setUpdatedByInfo(noticeEntity);
        ...
        // 등록자
        assertEquals(TestConstant.TEST_REGSTR_ID, noticeDto.getCreatedBy(), "등록자 ID가 제대로 매핑되지 않았습니다.");
