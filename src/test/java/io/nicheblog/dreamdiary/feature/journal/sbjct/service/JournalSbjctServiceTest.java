...
import io.nicheblog.dreamdiary.feature.journal.sbjct.model.JournalSbjctDtoTestFactory;
...
@Transactional
class JournalSbjctServiceTest {
    
    @Resource
    private JournalSbjctService journalSbjctService;

    @MockBean
    @SuppressWarnings("unused")
    private AuthUtils authUtils;

    private JournalSbjctDto journalSbjct;
    ...
    void setUp() throws Exception {
        // 공통적으로 사용할 JournalSbjctDto 초기화
        journalSbjct = JournalSbjctDtoTestFactory.create();
    ...
    void regist() throws Exception {
        ...
        // When::
        final ServiceResponse registResult = journalSbjctService.regist(journalSbjct);
        final JournalSbjctDto registered = (JournalSbjctDto) registResult.getRsltObj();
    ...
    void delete() throws Exception {
        ...
        // When::
        final ServiceResponse deleteResult = journalSbjctService.delete(key);
        ...
        assertThrows(EntityNotFoundException.class,
                () -> journalSbjctService.getDtlDto(key),
