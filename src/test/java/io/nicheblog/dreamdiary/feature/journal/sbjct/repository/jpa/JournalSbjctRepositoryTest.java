...
@Log4j2
class JournalSbjctRepositoryTest {

    @Resource
    private JournalSbjctRepository journalSbjctRepository;
    ...
    void setUp() throws Exception {
        ...
        journalSbjctEntity = JournalSbjctEntityTestFactory.create();
    }
    ...
    public void testRegist() throws Exception {
        ...
        // When::
        final JournalSbjctEntity registered = journalSbjctRepository.save(journalSbjctEntity);
        final Integer key = registered.getId();
        final JournalSbjctEntity retrieved = journalSbjctRepository.findById(key).orElseThrow(() -> new EntityNotFoundException(MessageUtils.getMessage("exception.EntityNotFoundException.registered")));
    ...
    public void testModify() throws Exception {
        // Given::
        JournalSbjctEntity registered = journalSbjctRepository.save(journalSbjctEntity);
        Integer key = registered.getId();

        // When::
        JournalSbjctEntity toModify = journalSbjctRepository.findById(key).orElseThrow(() -> new EntityNotFoundException(MessageUtils.getMessage("exception.EntityNotFoundException.to-modify")));
        toModify.setCn("modified");
        JournalSbjctEntity modified = journalSbjctRepository.save(toModify);
    ...
    public void testDelete() throws Exception {
        ...
        // When::
        final JournalSbjctEntity toDelete = journalSbjctRepository.findById(key).orElseThrow(() -> new EntityNotFoundException(MessageUtils.getMessage("exception.EntityNotFoundException.to-delete")));
        journalSbjctRepository.delete(toDelete);

        final JournalSbjctEntity retrieved = journalSbjctRepository.findById(key).orElse(null);
