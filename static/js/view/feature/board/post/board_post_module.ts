...
dF.BoardPost = (function(): dfModule {
    return {
        ...
        myPaprList: function(): void {
            ...
            const param: string = `??boardDef=${boardDef!}&searchType=nickNm&searchKeyword=${AuthInfo.nickNm!}&regstrId=${AuthInfo.username!}&pageSize=50&actionTyCd=MY_PAPR`;
        ...
        dtlModal: function(id: string|number): void {
            ...
            const ajaxData: Record<string, any> = { "id": id, "boardDef": $("#boardDef").val() };
