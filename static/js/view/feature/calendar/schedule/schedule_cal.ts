...
const Page: Page = (function(): Page {
    return {
        ...
        initChk: function(): void {
            const chkArr: JQuery<HTMLElement> = $("input:checkbox[id^='schedule_chk']");
        ...
        getEventList: function(): void {
            const url: string = Url.SCHEDULE_CAL_LIST_AJAX;
            // 날짜 세팅
            ...
            const chkArr: JQuery<HTMLElement> = $("input:checkbox[id^='schedule_chk_']");
            chkArr.each(function(_index: number, item: HTMLElement): void {
                const itemName = $(item).attr("name").replaceAll("schedule_chk_", "") + "ed";
