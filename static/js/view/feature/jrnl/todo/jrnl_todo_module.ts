...
dF.JrnlTodo = (function(): dfModule {
    return {
        ...
        regAjax: function(): void {
            const id = cF.util.getInputValue("#jrnlTodoRegForm [name='id']");
            ...
            Swal.fire({
                ...
                const url: string = isMdf ? cF.util.binfUrl(Url.JRNL_TODO, { id }) : Url.JRNL_TODOS;
        ...
        dtlModal: function(id: string|number): void {
            ...
            const url: string = cF.util.bindUrl(Url.JRNL_TODO, { id });
