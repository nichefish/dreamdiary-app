/**
 * jrnl_intrpt_tag_module.ts
 * 저널 해석 태그 스크립트 모듈
 * 
 * @author nichefish
 */
if (typeof dF === 'undefined') { var dF = {} as any; }
dF.JrnlIntrptTag = (function(): dfModule {
    return {
        initialized: false,
        ctgrMap: new Map(),
         ...
         */
        init: function(): void {
            if (dF.JrnlIntrptTag.initialized) return;

            dF.JrnlIntrptTag.getCtgrMap();

            dF.JrnlIntrptTag.initialized = true;
            console.log("'dF.JrnlIntrptTag' module initialized.");
        },
        ...
        getCtgrMap: function(): void {
            const url: string = Url.JRNL_INTRPT_TAG_CTGR_MAP;
            cF.ajax.get(url, {}, function(res: AjaxResponse): void {
                if (res.rsltMap) dF.JrnlIntrptTag.ctgrMap = res.rsltMap;
            });
        },
        ...
        listAjax: function(): void {
            ...
            const url: string = Url.JRNL_INTRPT_TAGS;
            ...
            cF.ajax.get(url, ajaxData, function(res: AjaxResponse): void {
                ...
                cF.handlebars.template(res.rsltList, "jrnl_intrpt_tag_list");
            });
        },
        ...
        dtlModal: function(tagId: string|number, tagNm: string): void {
            ...
            cF.ajax.get(url, null, function(res: AjaxResponse): void {
                ...
                cF.handlebars.modal(res.rsltList, "jrnl_intrpt_tag_dtl");
                document.querySelector("#jrnl_intrpt_tag_dtl_modal .header_tag_nm").innerHTML = tagNm;
                document.querySelector("#jrnl_intrpt_tag_dtl_modal .header_tag_cnt").innerHTML = (res.rsltList?.length ?? 0).toString();
